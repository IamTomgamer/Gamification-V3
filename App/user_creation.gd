...
func _on_save_user_pressed():
	...
	if user_name == "":
		show_error("Name is empty. Cannot create folder.")
		return
	...
	if not DirAccess.dir_exists_absolute(base_path):
		...
		if base_err != OK:
			show_error("Could not create base folder.")
			return
